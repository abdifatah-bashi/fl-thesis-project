...
HeartDiseaseNet is fully containerized with **Docker** and can be deployed on any platform that runs containers — your laptop, a VPS, AWS, Azure, GCP, DigitalOcean, Railway, Fly.io, or bare metal. The stack consists of two independent services: a **FastAPI backend** and a **Next.js frontend**.
